...
import kotlinx.android.synthetic.main.recycleitem_houly.view.*

class HourlyItem(context: Context): LinearLayout(context) {
    ...
    init {
        val view = LayoutInflater.from(context).inflate(R.layout.recycleitem_houly, null)
